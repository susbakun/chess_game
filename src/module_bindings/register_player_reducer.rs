...
pub trait register_player {
    ...
    fn register_player(&self, username: String) -> __sdk::Result<()> {
        self.register_player_then(username, |_, _| {})
    }
...
impl register_player for super::RemoteReducers {
    fn register_player_then(
        ...
        self.imp
            .invoke_reducer_with_callback(RegisterPlayerArgs { username }, callback)
    }
}
